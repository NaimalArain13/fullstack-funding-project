...
const Sidebar = () => {
  ...
  return (
    <div className="max-h-full">
      <div className={`flex ${isOpen ? "w-full" : "w-16"} transition-all duration-300 h-full bg-[#203e80] text-white`}>
        <div className="space-y-4 py-4 flex flex-col h-full">
          <div className="px-3 py-2 flex-1">
            <Link href="/admin-dashboard" className="flex items-center pl-3 mb:14">
              <div className="relative w-8 h-8 mr-4">
                <Image fill alt="logo" src="/download.jpg" className="rounded-full"/>
              </div>
              {isOpen && (
